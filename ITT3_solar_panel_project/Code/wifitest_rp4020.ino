...
char ssid[] = "NANO_RP4020";        // your network SSID (name)
char pass[] = "RP4020_NANO";    // your network password (use for WPA, or use as key for WEP)
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("<div class="w3-display-container w3" style="height:200px;">");
            client.print("");
            client.print("");
            client.print("");
            client.print("");
            client.print("");
            client.print("<style>");
            client.print(".container {margin: 1 auto; text-align: center; margin-top: 100px;}");
